        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form action="../../../Server/Config/Log/Register/index.php" method="post">
            ...
            <div data-mdb-input-init class="form-outline mb-4">
              ...
              <input type="text" id="form3Example3" class="form-control form-control-lg" placeholder="Enter username" name="username" />
            </div>
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              ...
              <p class="small fw-bold mt-2 pt-1 mb-0 text-center">Have an account? <a href="../Login/index.php" style="color: #4154f1;">Login</a></p>
              <p class="small fw-bold mt-2 pt-1 mb-0 text-center"><a href="../../index.php" class="link-secondary">Back</a></p>
            </div>
